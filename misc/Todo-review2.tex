...
- "using classical Java ... scheme": missing "the" (To check :mis au pluriel)
...
- l36 the quotation mark before code generation is the wrong one 'changed to ' and ' ?)
- p 14 "appertaining" -> "pertaining", "relating" (Kept as is. As verbs the difference between pertain and appertain is that pertain is to belong while appertain is to belong to or be a part of, whether by right, nature, appointment, or custom; to relate to.)
...
- p13, it is written twice that Pamela framework is extensively used. (DONE : 1 changed to largely)
