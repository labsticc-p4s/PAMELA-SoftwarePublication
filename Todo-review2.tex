...
- p5 and many times: "PAMELA metamodel", "PAMELA model", "PAMELA framework" need "the" before them.
- "defines API": insert "an"
- "in Java interface": insert "a"
- "returning desired value", "taking value" etc.: insert "the"
- "May also declares"...
...
Minors:
- POJO should be explain the first time p3 not the second time.
- p5 it is written twice that ModelEntities are encoded in a Java Interface
