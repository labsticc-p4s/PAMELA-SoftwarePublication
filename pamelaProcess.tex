...
\begin{itemize}
    ...
    \vspace{-0.2cm}\item \textbf{Aspect-oriented programming} : programmers may use or redefine "patterns" (eg Security Patterns \cite{silva20}) which offers code weaving at runtime, as well as runtime monitoring.
