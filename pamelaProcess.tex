...
\begin{itemize}
    ...
    \vspace{-0.2cm}\item \textbf{Reengineering} : programmers start from an existing base of code (legacy) and refactor it while replacing this code by abstract method declarations in Java interface, reducing risks of errors.
