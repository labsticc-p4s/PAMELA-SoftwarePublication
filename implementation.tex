...
Compared to a basic POJO (Plain Old Java Object) implementation, use of PAMELA involves a significant CPU and memory-footprint overhead, because of the partially-interpretated nature for some model features.
